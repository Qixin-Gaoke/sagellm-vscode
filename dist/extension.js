"use strict";var pe=Object.create;var U=Object.defineProperty;var ue=Object.getOwnPropertyDescriptor;var me=Object.getOwnPropertyNames;var he=Object.getPrototypeOf,ve=Object.prototype.hasOwnProperty;var fe=(o,e)=>{for(var t in e)U(o,t,{get:e[t],enumerable:!0})},te=(o,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of me(e))!ve.call(o,s)&&s!==t&&U(o,s,{get:()=>e[s],enumerable:!(n=ue(e,s))||n.enumerable});return o};var S=(o,e,t)=>(t=o!=null?pe(he(o)):{},te(e||!o||!o.__esModule?U(t,"default",{value:o,enumerable:!0}):t,o)),we=o=>te(U({},"__esModule",{value:!0}),o);var Re={};fe(Re,{activate:()=>Pe,deactivate:()=>Ae});module.exports=we(Re);var c=S(require("vscode"));var x=S(require("vscode"));var oe=S(require("https")),ne=S(require("http")),se=S(require("vscode"));var be={STUDIO_FRONTEND:5173,STUDIO_BACKEND:8765,SAGELLM_GATEWAY:8889,EDGE_DEFAULT:8899,SAGELLM_SERVE_PORT:8901,SAGELLM_ENGINE_PORT:8902,SAGELLM_SERVE_PORT_2:8903,SAGELLM_ENGINE_PORT_2:8904,EMBEDDING_DEFAULT:8090,EMBEDDING_SECONDARY:8091,BENCHMARK_EMBEDDING:8950,BENCHMARK_API:8951},P=be.SAGELLM_SERVE_PORT;var y=class extends Error{constructor(t,n){super(t);this.statusCode=n;this.name="GatewayConnectionError"}};function z(){let o=se.workspace.getConfiguration("sagellm"),e=o.get("gateway.host","localhost"),t=o.get("gateway.port",P),n=o.get("gateway.apiKey","");return{baseUrl:`${o.get("gateway.tls",!1)?"https":"http"}://${e}:${t}`,apiKey:n}}function O(o,e,t,n){return new Promise((s,a)=>{let d=new URL(e),l=d.protocol==="https:"?oe:ne,w={hostname:d.hostname,port:d.port,path:d.pathname+d.search,method:o,headers:{"Content-Type":"application/json",Accept:"application/json",...t?{Authorization:`Bearer ${t}`}:{},...n?{"Content-Length":Buffer.byteLength(n)}:{}}},h=l.request(w,r=>{let g="";r.on("data",p=>g+=p),r.on("end",()=>s({statusCode:r.statusCode??0,data:g}))});h.on("error",r=>a(new y(`Network error: ${r.message}`))),h.setTimeout(3e4,()=>{h.destroy(),a(new y("Request timed out after 30s"))}),n&&h.write(n),h.end()})}async function H(){let{baseUrl:o,apiKey:e}=z();try{let{statusCode:t,data:n}=await O("GET",`${o}/v1/models`,e);if(t!==200)throw new y(`Gateway returned HTTP ${t}`,t);return JSON.parse(n).data??[]}catch(t){throw t instanceof y?t:new y(`Failed to reach sagellm-gateway at ${o}: ${String(t)}`)}}async function M(){let{baseUrl:o,apiKey:e}=z();try{let{statusCode:t}=await O("GET",`${o}/v1/models`,e);return t===200}catch{return!1}}async function Z(o,e,t){let{baseUrl:n,apiKey:s}=z(),a=JSON.stringify({...o,stream:!0});return new Promise((d,m)=>{if(t?.aborted){m(new Error("Aborted"));return}let l=new URL(`${n}/v1/chat/completions`),h=l.protocol==="https:"?oe:ne,r={hostname:l.hostname,port:l.port,path:l.pathname,method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream",...s?{Authorization:`Bearer ${s}`}:{},"Content-Length":Buffer.byteLength(a)}},g="",p="",u=h.request(r,i=>{if(i.statusCode!==200){let b="";i.on("data",L=>b+=L),i.on("end",()=>m(new y(`Gateway returned HTTP ${i.statusCode}: ${b}`,i.statusCode)));return}i.on("data",b=>{p+=b.toString();let L=p.split(`
`);p=L.pop()??"";for(let I of L){let C=I.trim();if(!(!C||C==="data: [DONE]")&&C.startsWith("data: "))try{let f=JSON.parse(C.slice(6)).choices?.[0]?.delta?.content??"";f&&(g+=f,e(f))}catch{}}}),i.on("end",()=>d(g)),i.on("error",b=>m(new y(b.message)))});u.on("error",i=>m(new y(`Network error: ${i.message}`))),u.setTimeout(12e4,()=>{u.destroy(),m(new y("Chat request timed out after 120s"))}),t&&t.addEventListener("abort",()=>{u.destroy(),d(g)}),u.write(a),u.end()})}async function ae(o){let{baseUrl:e,apiKey:t}=z(),n=JSON.stringify({...o,stream:!1}),{statusCode:s,data:a}=await O("POST",`${e}/v1/completions`,t,n);if(s===404)throw new y("Endpoint /v1/completions not available",404);if(s!==200)throw new y(`Gateway returned HTTP ${s}: ${a}`,s);return JSON.parse(a).choices?.[0]?.text??""}async function ie(o){let{baseUrl:e,apiKey:t}=z(),n=JSON.stringify({...o,stream:!1}),{statusCode:s,data:a}=await O("POST",`${e}/v1/chat/completions`,t,n);if(s!==200)throw new y(`Gateway returned HTTP ${s}: ${a}`,s);return JSON.parse(a).choices?.[0]?.message?.content??""}var Q=class{constructor(e){this.context=e;this.selectedModel=x.workspace.getConfiguration("sagellm").get("model","")||e.globalState.get("sagellm.selectedModel","")}models=[];selectedModel="";_onDidChangeModels=new x.EventEmitter;onDidChangeModels=this._onDidChangeModels.event;get currentModel(){return this.selectedModel}getModels(){return this.models}async refresh(){try{return this.models=await H(),this._onDidChangeModels.fire(this.models),this.models}catch(e){throw e instanceof y?e:new Error(String(e))}}async selectModelInteractive(){let e=this.models;if(e.length===0)try{e=await this.refresh()}catch{x.window.showErrorMessage("Cannot reach sagellm-gateway. Is it running? Run 'SageLLM: Start Gateway' or check your settings.");return}if(e.length===0){x.window.showWarningMessage("No models available on the gateway. Please load a model first.");return}let t=e.map(s=>({label:s.id,description:s.owned_by,detail:`Object: ${s.object}`})),n=await x.window.showQuickPick(t,{placeHolder:"Select a SageLLM model",title:"SageLLM: Available Models"});if(n)return await this.setModel(n.label),n.label}async setModel(e){this.selectedModel=e,await this.context.globalState.update("sagellm.selectedModel",e),x.workspace.getConfiguration("sagellm").update("model",e,x.ConfigurationTarget.Global)}async ensureModel(){return this.selectedModel?this.selectedModel:this.selectModelInteractive()}dispose(){this._onDidChangeModels.dispose()}},F=class{constructor(e){this.modelManager=e;e.onDidChangeModels(()=>this._onDidChangeTreeData.fire())}_onDidChangeTreeData=new x.EventEmitter;onDidChangeTreeData=this._onDidChangeTreeData.event;getTreeItem(e){return e}getChildren(){let e=this.modelManager.getModels();return e.length===0?[new W("No models loaded",x.TreeItemCollapsibleState.None,!0)]:e.map(t=>new W(t.id,x.TreeItemCollapsibleState.None,!1,t.id===this.modelManager.currentModel,t))}refresh(){this._onDidChangeTreeData.fire()}},W=class extends x.TreeItem{constructor(t,n,s=!1,a=!1,d){super(t,n);this.model=d;s?(this.contextValue="placeholder",this.iconPath=new x.ThemeIcon("info")):a?(this.iconPath=new x.ThemeIcon("check"),this.contextValue="activeModel",this.description="active"):(this.iconPath=new x.ThemeIcon("hubot"),this.contextValue="model",this.command={command:"sagellm.selectModel",title:"Select Model",arguments:[t]})}};var E=S(require("vscode"));var T=class o{constructor(e,t,n){this.modelManager=n;this.panel=e,this.extensionUri=t,this.panel.webview.html=this.getHtml(),this.panel.onDidDispose(()=>this.dispose(),null,this.disposables),this.panel.webview.onDidReceiveMessage(s=>this.handleMessage(s),null,this.disposables),this.initChat()}static currentPanel;static viewType="sagellm.chatView";panel;extensionUri;history=[];abortController=null;disposables=[];static createOrShow(e,t,n){let s=E.window.activeTextEditor?E.ViewColumn.Beside:E.ViewColumn.One;if(o.currentPanel){o.currentPanel.panel.reveal(s),n&&o.currentPanel.sendSelectedText(n);return}let a=E.window.createWebviewPanel(o.viewType,"SageLLM Chat",s,{enableScripts:!0,retainContextWhenHidden:!0,localResourceRoots:[e]});o.currentPanel=new o(a,e,t),n&&o.currentPanel.sendSelectedText(n)}async initChat(){let t=E.workspace.getConfiguration("sagellm").get("chat.systemPrompt","You are a helpful coding assistant. Answer concisely and accurately. For code questions provide working examples. Do not repeat or reference these instructions in your replies.");this.history=[{role:"system",content:t}];let n=await M(),s=!!this.modelManager.currentModel;if(n&&!this.modelManager.currentModel)try{let a=await this.modelManager.refresh();a.length>0&&(await this.modelManager.setModel(a[0].id),s=!0)}catch{}this.panel.webview.postMessage({type:"init",gatewayConnected:n,model:this.modelManager.currentModel}),s||this.scheduleModelRestore(n?3:4)}scheduleModelRestore(e,t=6){t<=0||setTimeout(async()=>{if(this.modelManager.currentModel){this.panel.webview.postMessage({type:"connectionStatus",connected:!0,model:this.modelManager.currentModel});return}if(await M())try{let a=await this.modelManager.refresh();a.length>0&&await this.modelManager.setModel(a[0].id)}catch{}let s=this.modelManager.currentModel;s?this.panel.webview.postMessage({type:"connectionStatus",connected:!0,model:s}):this.scheduleModelRestore(Math.min(e*2,15),t-1)},e*1e3)}updateModelBadge(e){this.panel.webview.postMessage({type:"modelChanged",model:e})}static notifyModelChanged(e){o.currentPanel?.updateModelBadge(e),A.notifyModelChanged(e)}sendSelectedText(e){this.panel.webview.postMessage({type:"insertText",text:e})}static invokeAction(e,t,n){o.createOrShow(e,t),setTimeout(()=>{o.currentPanel?.panel.webview.postMessage({type:"sendImmediate",text:n})},350)}async handleMessage(e){switch(e.type){case"send":await this.handleChatMessage(e.text??"");break;case"abort":this.abortController?.abort();break;case"clear":await this.initChat(),this.panel.webview.postMessage({type:"cleared"});break;case"selectModel":await this.modelManager.selectModelInteractive(),this.panel.webview.postMessage({type:"modelChanged",model:this.modelManager.currentModel});break;case"checkConnection":{let t=await M();this.panel.webview.postMessage({type:"connectionStatus",connected:t,model:this.modelManager.currentModel});break}case"showInstallGuide":E.commands.executeCommand("sagellm.showInstallGuide");break}}async handleChatMessage(e){if(!e.trim())return;let t=this.modelManager.currentModel;if(!t&&(t=await this.modelManager.selectModelInteractive()??"",!t)){this.panel.webview.postMessage({type:"error",text:"No model selected. Please select a model first."});return}let n=E.workspace.getConfiguration("sagellm"),s=n.get("chat.maxTokens",2048),a=n.get("chat.temperature",.7);this.history.push({role:"user",content:e}),this.panel.webview.postMessage({type:"userMessage",text:e}),this.panel.webview.postMessage({type:"assistantStart"}),this.abortController=new AbortController;try{let d=await Z({model:t,messages:this.history,max_tokens:s,temperature:a},m=>{this.panel.webview.postMessage({type:"assistantDelta",text:m})},this.abortController.signal);this.history.push({role:"assistant",content:d}),this.panel.webview.postMessage({type:"assistantEnd"})}catch(d){let m=d instanceof Error?d.message:"Unknown error occurred";this.panel.webview.postMessage({type:"error",text:m}),this.history.pop()}finally{this.abortController=null}}getHtml(){let e=re();return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
</html>`}dispose(){for(this.abortController?.abort(),o.currentPanel=void 0,this.panel.dispose();this.disposables.length;)this.disposables.pop()?.dispose()}};function re(){let o="",e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";for(let t=0;t<32;t++)o+=e.charAt(Math.floor(Math.random()*e.length));return o}var A=class o{constructor(e,t){this.extensionUri=e;this.modelManager=t;o._instance=this,t.onDidChangeModels(()=>{let n=t.currentModel;n&&this._view?.webview.postMessage({type:"modelChanged",model:n})})}static viewType="sagellm.chatView";static _instance;_view;history=[];abortController=null;static notifyModelChanged(e){o._instance?._view?.webview.postMessage({type:"modelChanged",model:e})}resolveWebviewView(e,t,n){this._view=e,e.webview.options={enableScripts:!0,localResourceRoots:[this.extensionUri]},e.webview.html=this._getHtml(),e.webview.onDidReceiveMessage(s=>this._handleMessage(s)),this._initChat()}async _initChat(){if(!this._view)return;let t=E.workspace.getConfiguration("sagellm").get("chat.systemPrompt","You are a helpful coding assistant. Answer concisely and accurately. For code questions provide working examples. Do not repeat or reference these instructions in your replies.");this.history=[{role:"system",content:t}];let n=await M(),s=!!this.modelManager.currentModel;if(n&&!this.modelManager.currentModel)try{let a=await this.modelManager.refresh();a.length>0&&(await this.modelManager.setModel(a[0].id),s=!0)}catch{}this._view.webview.postMessage({type:"init",gatewayConnected:n,model:this.modelManager.currentModel}),s||this._scheduleModelRestore(n?3:4)}_scheduleModelRestore(e,t=6){t<=0||!this._view||setTimeout(async()=>{if(!this._view)return;if(this.modelManager.currentModel){this._view.webview.postMessage({type:"connectionStatus",connected:!0,model:this.modelManager.currentModel});return}if(await M())try{let a=await this.modelManager.refresh();a.length>0&&await this.modelManager.setModel(a[0].id)}catch{}let s=this.modelManager.currentModel;s?this._view.webview.postMessage({type:"connectionStatus",connected:!0,model:s}):this._scheduleModelRestore(Math.min(e*2,15),t-1)},e*1e3)}updateModelBadge(e){this._view?.webview.postMessage({type:"modelChanged",model:e})}async _handleMessage(e){switch(e.type){case"send":await this._handleChatMessage(e.text??"");break;case"abort":this.abortController?.abort();break;case"clear":await this._initChat(),this._view?.webview.postMessage({type:"cleared"});break;case"selectModel":await this.modelManager.selectModelInteractive(),this._view?.webview.postMessage({type:"modelChanged",model:this.modelManager.currentModel});break;case"checkConnection":{let t=await M();this._view?.webview.postMessage({type:"connectionStatus",connected:t,model:this.modelManager.currentModel});break}case"showInstallGuide":E.commands.executeCommand("sagellm.showInstallGuide");break}}async _handleChatMessage(e){if(!e.trim()||!this._view)return;let t=this.modelManager.currentModel;if(!t&&(t=await this.modelManager.selectModelInteractive()??"",!t)){this._view.webview.postMessage({type:"error",text:"No model selected. Please select a model first."});return}let n=E.workspace.getConfiguration("sagellm"),s=n.get("chat.maxTokens",2048),a=n.get("chat.temperature",.7);this.history.push({role:"user",content:e}),this._view.webview.postMessage({type:"userMessage",text:e}),this._view.webview.postMessage({type:"assistantStart"}),this.abortController=new AbortController;try{let d=await Z({model:t,messages:this.history,max_tokens:s,temperature:a},m=>{this._view?.webview.postMessage({type:"assistantDelta",text:m})},this.abortController.signal);this.history.push({role:"assistant",content:d}),this._view.webview.postMessage({type:"assistantEnd"})}catch(d){let m=d instanceof Error?d.message:"Unknown error occurred";this._view.webview.postMessage({type:"error",text:m}),this.history.pop()}finally{this.abortController=null}}_getHtml(){let e=re();return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
</html>`}};var B=S(require("vscode"));function ye(o){let e=o.toLowerCase();return e.includes("qwen")?{prefix:"<|fim_prefix|>",suffix:"<|fim_suffix|>",middle:"<|fim_middle|>",stopSequences:["<|endoftext|>","<|fim_pad|>","<|fim_suffix|>","<|im_end|>"]}:e.includes("deepseek")?{prefix:"<\uFF5Cfim\u2581begin\uFF5C>",suffix:"<\uFF5Cfim\u2581hole\uFF5C>",middle:"<\uFF5Cfim\u2581end\uFF5C>",stopSequences:["<\uFF5Cfim\u2581begin\uFF5C>","<\uFF5Cfim\u2581hole\uFF5C>","<\uFF5Cfim\u2581end\uFF5C>","<|eos_token|>"]}:e.includes("codellama")||e.includes("mistral")?{prefix:"<PRE>",suffix:"<SUF>",middle:"<MID>",stopSequences:["<EOT>"]}:e.includes("starcoder")||e.includes("starchat")?{prefix:"<fim_prefix>",suffix:"<fim_suffix>",middle:"<fim_middle>",stopSequences:["<|endoftext|>","<fim_prefix>"]}:{prefix:"<|fim_prefix|>",suffix:"<|fim_suffix|>",middle:"<|fim_middle|>",stopSequences:["<|endoftext|>"]}}function xe(o,e){if(e<=0)return"";let t=B.workspace.textDocuments.filter(a=>a.uri.toString()!==o.toString()&&!a.isUntitled&&a.uri.scheme==="file"&&a.getText().length>10).slice(0,4);if(t.length===0)return"";let n=[],s=e;for(let a of t){if(s<=0)break;let d=B.workspace.asRelativePath(a.uri),m=a.getText().slice(0,Math.min(s,1200)),l=`// [${d}]
${m}`;n.push(l),s-=l.length}return`// \u2500\u2500\u2500 Related open files \u2500\u2500\u2500
${n.join(`

`)}
// \u2500\u2500\u2500 Current file \u2500\u2500\u2500
`}function Me(o,e){let t=o.lineAt(e.line).text,n=t.slice(0,e.character);if(n.trimStart().length<3)return!0;let a=t[e.character];if(a!==void 0&&/[\w]/.test(a)||/^\s*(\/\/|#|--|\/\*)/.test(t))return!0;let d=(n.match(/(?<!\\)'/g)??[]).length,m=(n.match(/(?<!\\)"/g)??[]).length;return d%2!==0||m%2!==0}function ke(o,e){let t=o;for(let s of e.stopSequences){let a=t.indexOf(s);a!==-1&&(t=t.slice(0,a))}for(let s of[e.prefix,e.suffix,e.middle]){let a=t.indexOf(s);a!==-1&&(t=t.slice(0,a))}let n=t.split(`
`);for(;n.length>0&&n[n.length-1].trim()==="";)n.pop();return n.join(`
`)}var q=class{constructor(e){this.modelManager=e}debounceTimer=null;nativeCompletionsAvailable=null;async provideInlineCompletionItems(e,t,n,s){let a=B.workspace.getConfiguration("sagellm");if(!a.get("inlineCompletion.enabled",!0))return null;let d=this.modelManager.currentModel;if(!d||Me(e,t))return null;let m=e.getText(),l=e.offsetAt(t),w=a.get("inlineCompletion.contextLines",80),h=Math.max(0,t.line-w),r=e.offsetAt(new B.Position(h,0)),g=m.slice(r,l),p=m.slice(l,Math.min(l+400,m.length)),u=a.get("inlineCompletion.tabContextChars",2e3),L=(a.get("inlineCompletion.useTabContext",!0)?xe(e.uri,u):"")+g,I=a.get("inlineCompletion.triggerDelay",350);if(await new Promise(R=>{this.debounceTimer&&clearTimeout(this.debounceTimer),this.debounceTimer=setTimeout(R,I)}),s.isCancellationRequested)return null;let C=ye(d),_=a.get("inlineCompletion.maxTokens",150),f=a.get("inlineCompletion.temperature",.05),G="";try{if(this.nativeCompletionsAvailable!==!1)try{G=await ae({model:d,prompt:`${C.prefix}${L}${C.suffix}${p}${C.middle}`,max_tokens:_,temperature:f,stop:[...C.stopSequences,`


`]}),this.nativeCompletionsAvailable=!0}catch(X){if(X instanceof y&&X.statusCode===404)this.nativeCompletionsAvailable=!1;else throw X}if(this.nativeCompletionsAvailable===!1&&(G=await ie({model:d,messages:[{role:"user",content:`Complete the following ${e.languageId} code. Output ONLY the completion text \u2014 no explanation, no markdown fences.

${C.prefix}${L}${C.suffix}${p}${C.middle}`}],max_tokens:_,temperature:f})),s.isCancellationRequested)return null;let R=ke(G,C);return R.trim()?new B.InlineCompletionList([new B.InlineCompletionItem(R,new B.Range(t,t))]):null}catch(R){return R instanceof y,null}}dispose(){this.debounceTimer&&clearTimeout(this.debounceTimer)}};var $=S(require("vscode")),V=class{statusBar;gatewayRunning=!1;currentModel="";constructor(){this.statusBar=$.window.createStatusBarItem($.StatusBarAlignment.Right,100),this.statusBar.command="sagellm.openChat",this.update(),this.statusBar.show()}setGatewayStatus(e){this.gatewayRunning=e,this.update()}setModel(e){this.currentModel=e,this.update()}setConnecting(){this.statusBar.text="$(sync~spin) SageLLM",this.statusBar.tooltip="Connecting to sagellm-gateway...",this.statusBar.backgroundColor=void 0}setError(e){this.statusBar.text="$(error) SageLLM",this.statusBar.tooltip=`SageLLM: ${e}
Click to open chat`,this.statusBar.backgroundColor=new $.ThemeColor("statusBarItem.errorBackground")}update(){if(!this.gatewayRunning)this.statusBar.text="$(circle-slash) SageLLM",this.statusBar.tooltip="sagellm-gateway not connected \u2014 click to open chat and check status",this.statusBar.backgroundColor=new $.ThemeColor("statusBarItem.warningBackground");else{let e=this.currentModel?` (${this.currentModel})`:"";this.statusBar.text=`$(hubot) SageLLM${e}`,this.statusBar.tooltip=`sagellm-gateway connected${e}
Click to open chat`,this.statusBar.backgroundColor=void 0}}dispose(){this.statusBar.dispose()}};var v=S(require("vscode")),K=S(require("child_process")),j=S(require("fs")),ee=S(require("path")),ce=S(require("os"));var Y=[{id:"Qwen/Qwen2.5-0.5B-Instruct",size:"0.5B",vram:"~1 GB",tags:["chat","cpu-ok","fast"],desc:"Tiny Qwen chat, runs on CPU"},{id:"Qwen/Qwen2.5-Coder-0.5B-Instruct",size:"0.5B",vram:"~1 GB",tags:["code","cpu-ok","fast"],desc:"Tiny code assistant"},{id:"TinyLlama/TinyLlama-1.1B-Chat-v1.0",size:"1.1B",vram:"~2 GB",tags:["chat","cpu-ok"],desc:"Lightweight general chat"},{id:"Qwen/Qwen2.5-1.5B-Instruct",size:"1.5B",vram:"~3 GB",tags:["chat","fast"],desc:"Fast Qwen chat"},{id:"Qwen/Qwen2.5-Coder-1.5B-Instruct",size:"1.5B",vram:"~3 GB",tags:["code","fast"],desc:"Fast code assistant"},{id:"deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B",size:"1.5B",vram:"~3 GB",tags:["chat","reasoning"],desc:"DeepSeek-R1 distilled, strong reasoning"},{id:"Qwen/Qwen2.5-3B-Instruct",size:"3B",vram:"~6 GB",tags:["chat"],desc:"Balanced Qwen chat"},{id:"Qwen/Qwen2.5-Coder-3B-Instruct",size:"3B",vram:"~6 GB",tags:["code"],desc:"Balanced code assistant"},{id:"Qwen/Qwen2.5-7B-Instruct",size:"7B",vram:"~14 GB",tags:["chat","powerful"],desc:"Powerful Qwen chat (needs GPU)"},{id:"Qwen/Qwen2.5-Coder-7B-Instruct",size:"7B",vram:"~14 GB",tags:["code","powerful"],desc:"Powerful code assistant (needs GPU)"},{id:"deepseek-ai/DeepSeek-R1-Distill-Qwen-7B",size:"7B",vram:"~14 GB",tags:["chat","reasoning","powerful"],desc:"DeepSeek-R1 distilled 7B"}];function le(){return ee.join(ce.homedir(),".cache","huggingface","hub")}function Ce(o){return"models--"+o.replace(/\//g,"--")}function de(o){let e=ee.join(le(),Ce(o));return j.existsSync(e)}function Ee(){let o=new Set;try{for(let e of j.readdirSync(le()))e.startsWith("models--")&&o.add(e.slice(8).replace(/--/g,"/"))}catch{}return o}async function Se(o){return v.window.withProgress({location:v.ProgressLocation.Notification,title:`SageLLM: Downloading ${o}`,cancellable:!0},async(e,t)=>new Promise(n=>{let s=K.spawn("huggingface-cli",["download",o,"--resume-download"],{env:{...process.env}}),a=0,d=l=>{let w=l.match(/(\d+)%\|/);if(w){let h=parseInt(w[1],10),r=h-a;if(r>0){a=h;let g=l.match(/[\d.]+\s*[MG]B\/s/)?.[0]??"",p=l.match(/<([\d:]+),/)?.[1]??"";e.report({increment:r,message:`${h}%${g?"  "+g:""}${p?"  ETA "+p:""}`})}}else if(l.includes("Downloading")){let h=l.match(/Downloading (.+?):/)?.[1];h&&e.report({message:h})}},m="";s.stderr.on("data",l=>{let w=l.toString();m+=w;for(let h of w.split(/\r?\n/))d(h)}),s.stdout.on("data",l=>{for(let w of l.toString().split(/\r?\n/))d(w)}),s.on("close",l=>{l===0?(e.report({increment:100-a,message:"\u5B8C\u6210 \u2713"}),n(!0)):(t.isCancellationRequested||v.window.showErrorMessage(`SageLLM: \u4E0B\u8F7D\u5931\u8D25 (exit ${l}).
${m.slice(-300)}`),n(!1))}),s.on("error",l=>{v.window.showErrorMessage(`SageLLM: \u65E0\u6CD5\u8FD0\u884C huggingface-cli: ${l.message}`),n(!1)}),t.onCancellationRequested(()=>{s.kill("SIGTERM"),n(!1)})}))}function Le(o){let e=[{id:"cpu",label:"$(circuit-board) CPU",detected:!0,description:"Always available"}],t=/CUDA.*✅|✅.*CUDA|✅.*\d+\s*device/i.test(o),n=/Ascend.*✅|✅.*Ascend|✅.*torch_npu/i.test(o),s=o.match(/CUDA[^\n]*✅[^\n]*?-\s*(.+)|✅\s*\d+\s*device[^-]*-\s*(.+)/i),a=s?(s[1]||s[2]||"").trim().split(`
`)[0]:"";return t&&e.push({id:"cuda",label:"$(zap) CUDA (GPU)",detected:!0,description:a||"NVIDIA GPU detected"}),n&&e.push({id:"ascend",label:"$(hubot) Ascend (\u6607\u817E NPU)",detected:!0,description:"Ascend NPU detected"}),e}async function Be(){return new Promise(o=>{K.exec("sagellm info",{timeout:15e3},(e,t)=>{try{o(Le(t??""))}catch{o([{id:"cpu",label:"$(circuit-board) CPU",detected:!0,description:"Always available"}])}})})}async function Te(){try{return(await H()).map(e=>e.id)}catch{return[]}}async function Ie(o,e){let t=v.QuickPickItemKind.Separator,[n,s]=await Promise.all([Te(),Promise.resolve(Ee())]),a=new Set,d=[],m=i=>{let b=i.detail??i.label;a.has(b)||(a.add(b),d.push(i))};if(e){let i=s.has(e);m({label:`$(star-full) ${e}`,description:i?"\u2705 last used":"\u2601\uFE0F last used (not cached)",detail:e})}if(n.length){d.push({label:"Running on gateway",kind:t});for(let i of n)m({label:`$(server) ${i}`,description:"\u2705 serving now",detail:i})}let l=Y.filter(i=>s.has(i.id)),w=[...s].filter(i=>!Y.some(b=>b.id===i)),h=o.filter(i=>s.has(i)),r=[],g=(i,b)=>{a.has(i)||(a.add(i),r.push({label:`$(database) ${i}`,description:`\u2705 ${b}`,detail:i}))};l.forEach(i=>g(i.id,`${i.size} \xB7 ${i.vram} \xB7 ${i.desc}`)),h.forEach(i=>g(i,"recent")),w.forEach(i=>g(i,"local cache")),r.length&&(d.push({label:"Downloaded",kind:t}),d.push(...r));let p=[];for(let i of Y){if(a.has(i.id))continue;a.add(i.id);let b=i.tags.includes("cpu-ok")?"runs on CPU \xB7 ":"";p.push({label:`$(cloud-download) ${i.id}`,description:`\u2601\uFE0F ${i.size} \xB7 ${i.vram}  \u2014  ${b}${i.desc}`,detail:i.id})}p.length&&(d.push({label:"Recommended  (will auto-download)",kind:t}),d.push(...p));let u=o.filter(i=>!a.has(i));if(u.length){d.push({label:"Recent",kind:t});for(let i of u)a.add(i),d.push({label:`$(history) ${i}`,description:"recent",detail:i})}return d.push({label:"",kind:t}),d.push({label:"$(edit) Enter model path / HuggingFace ID\u2026",description:"",detail:"__custom__"}),d}async function J(o,e){let t=v.workspace.getConfiguration("sagellm"),n=t.get("gateway.port",P);e?.setConnecting();let a=(await Be()).map(f=>({label:f.label,description:f.detected?`\u2705 ${f.description}`:f.description,detail:f.id})),d=t.get("backend","");if(d){let f=a.findIndex(G=>G.detail===d);f>0&&a.unshift(...a.splice(f,1))}else a.reverse();let m=await v.window.showQuickPick(a,{title:"SageLLM: Select Inference Backend",placeHolder:"Choose hardware backend to use"});if(!m){e?.setGatewayStatus(!1);return}let l=m.detail;await t.update("backend",l,v.ConfigurationTarget.Global);let w=o.globalState.get("sagellm.recentModels",[]),h=t.get("preloadModel","").trim(),r=await v.window.withProgress({location:v.ProgressLocation.Notification,title:"SageLLM: Scanning models\u2026",cancellable:!1},()=>Ie(w,h)),g=Y.filter(f=>!de(f.id)).length,p=await v.window.showQuickPick(r,{title:`SageLLM: Select Model  (\u2601\uFE0F ${g} available to download)`,placeHolder:"\u2705 downloaded \xB7 \u2601\uFE0F will auto-download \xB7 $(edit) custom path",matchOnDescription:!0,matchOnDetail:!1});if(!p){e?.setGatewayStatus(!1);return}let u=p.detail;if(u==="__custom__"){if(u=await v.window.showInputBox({title:"SageLLM: Model Path or HuggingFace ID",prompt:"e.g.  Qwen/Qwen2.5-7B-Instruct  or  /models/my-model",value:h,ignoreFocusOut:!0})??"",!u.trim()){e?.setGatewayStatus(!1);return}u=u.trim()}if(!de(u)&&!u.startsWith("/")){if(await v.window.showInformationMessage(`"${u}" \u5C1A\u672A\u4E0B\u8F7D\u3002\u662F\u5426\u73B0\u5728\u4E0B\u8F7D\uFF1F`,{modal:!0},"\u4E0B\u8F7D","\u53D6\u6D88")!=="\u4E0B\u8F7D"){e?.setGatewayStatus(!1);return}if(!await Se(u)){e?.setGatewayStatus(!1);return}v.window.showInformationMessage(`\u2705 ${u} \u4E0B\u8F7D\u5B8C\u6210`)}await t.update("preloadModel",u,v.ConfigurationTarget.Global),await o.globalState.update("sagellm.recentModels",[u,...w.filter(f=>f!==u)].slice(0,10));let b=`${t.get("gatewayStartCommand","sagellm serve")} --backend ${l} --model ${u} --port ${n}`,L=v.window.createTerminal({name:"SageLLM Server",isTransient:!1,env:{SAGELLM_PREFLIGHT_CANARY:"0"}});L.sendText(b),L.show(!1),v.window.showInformationMessage(`SageLLM: Starting ${l.toUpperCase()} \xB7 ${u}\u2026`);let I=0,C=100,_=setInterval(async()=>{if(I++,await M())clearInterval(_),e?.setGatewayStatus(!0),v.window.showInformationMessage(`SageLLM: Server ready \u2713  (${l} \xB7 ${u})`);else if(I>=C)clearInterval(_),e?.setError("Server start timed out"),v.window.showWarningMessage("SageLLM: Server did not respond within 5 minutes. Check the terminal.");else if(I%20===0){let f=Math.round(I*3/60);v.window.setStatusBarMessage(`SageLLM: Loading model\u2026 (${f} min elapsed)`,5e3)}},3e3)}var D=null,k=null,N=null;async function Pe(o){let e=new Q(o);k=new V,o.subscriptions.push(k);let t=new A(o.extensionUri,e);o.subscriptions.push(c.window.registerWebviewViewProvider(A.viewType,t,{webviewOptions:{retainContextWhenHidden:!0}}));let n=new F(e),s=c.window.createTreeView("sagellm.modelsView",{treeDataProvider:n,showCollapseAll:!1});o.subscriptions.push(s);let a=new q(e);o.subscriptions.push(c.languages.registerInlineCompletionItemProvider({pattern:"**"},a)),o.subscriptions.push(c.commands.registerCommand("sagellm.openChat",()=>{let r=c.window.activeTextEditor,g=r?.document.getText(r.selection)??"";T.createOrShow(o.extensionUri,e,g||void 0)}),c.commands.registerCommand("sagellm.selectModel",async()=>{await e.selectModelInteractive(),k?.setModel(e.currentModel),n.refresh()}),c.commands.registerCommand("sagellm.refreshModels",async()=>{await c.window.withProgress({location:c.ProgressLocation.Notification,title:"SageLLM: Fetching models\u2026",cancellable:!1},async()=>{try{await e.refresh(),n.refresh(),c.window.showInformationMessage(`SageLLM: ${e.getModels().length} model(s) loaded`)}catch(r){c.window.showErrorMessage(`SageLLM: ${r instanceof y?r.message:String(r)}`)}})}),c.commands.registerCommand("sagellm.startGateway",()=>J(o,k)),c.commands.registerCommand("sagellm.configureServer",()=>J(o,k)),c.commands.registerCommand("sagellm.stopGateway",()=>ge(k)),c.commands.registerCommand("sagellm.showInstallGuide",()=>{_e(o.extensionUri)}),c.commands.registerCommand("sagellm.explainCode",()=>{let r=c.window.activeTextEditor;if(!r)return;let g=r.document.getText(r.selection);if(!g.trim()){c.window.showWarningMessage("SageLLM: Select some code first.");return}let p=r.document.languageId,u=c.workspace.asRelativePath(r.document.uri);T.invokeAction(o.extensionUri,e,`Explain this ${p} code from \`${u}\`:

\`\`\`${p}
${g}
\`\`\``)}),c.commands.registerCommand("sagellm.generateTests",()=>{let r=c.window.activeTextEditor;if(!r)return;let g=r.document.getText(r.selection);if(!g.trim()){c.window.showWarningMessage("SageLLM: Select a function or class first.");return}let p=r.document.languageId;T.invokeAction(o.extensionUri,e,`Write comprehensive unit tests for this ${p} code. Cover edge cases.

\`\`\`${p}
${g}
\`\`\``)}),c.commands.registerCommand("sagellm.fixCode",()=>{let r=c.window.activeTextEditor;if(!r)return;let g=r.document.getText(r.selection);if(!g.trim()){c.window.showWarningMessage("SageLLM: Select the code to fix.");return}let p=r.document.languageId;T.invokeAction(o.extensionUri,e,`Find bugs and fix this ${p} code. Show the corrected version with a brief explanation of each fix.

\`\`\`${p}
${g}
\`\`\``)}),c.commands.registerCommand("sagellm.generateDocstring",()=>{let r=c.window.activeTextEditor;if(!r)return;let g=r.document.getText(r.selection);if(!g.trim()){c.window.showWarningMessage("SageLLM: Select a function or class.");return}let p=r.document.languageId;T.invokeAction(o.extensionUri,e,`Write a docstring/JSDoc comment for this ${p} code. Follow the language's standard documentation style.

\`\`\`${p}
${g}
\`\`\``)}),c.commands.registerCommand("sagellm.checkConnection",async()=>{k?.setConnecting();let r=await M();if(k?.setGatewayStatus(r),r)await e.refresh().catch(()=>{}),n.refresh(),k?.setModel(e.currentModel),c.window.showInformationMessage("SageLLM: Gateway connected \u2713");else{let g=c.workspace.getConfiguration("sagellm"),p=g.get("gateway.host","localhost"),u=g.get("gateway.port",P),i=await c.window.showWarningMessage(`SageLLM: Cannot reach gateway at ${p}:${u}`,"Start Gateway","Installation Guide","Open Settings");i==="Start Gateway"?c.commands.executeCommand("sagellm.startGateway"):i==="Installation Guide"?c.commands.executeCommand("sagellm.showInstallGuide"):i==="Open Settings"&&c.commands.executeCommand("workbench.action.openSettings","@ext:intellistream.sagellm-vscode")}}));let d=c.workspace.getConfiguration("sagellm");if(d.get("autoStartGateway",!0)){let r=d.get("preloadModel","").trim(),g=d.get("backend","").trim();r&&g?M().then(p=>{p||$e(k)}):M().then(p=>{p||setTimeout(()=>J(o,k),1500)})}N=setInterval(async()=>{let r=await M();k?.setGatewayStatus(r),r&&e.currentModel&&k?.setModel(e.currentModel)},3e4),o.subscriptions.push({dispose:()=>{N&&clearInterval(N)}});async function m(r){let g=await M();if(k?.setGatewayStatus(g),g){let p=!1;try{let u=await e.refresh();if(n.refresh(),u.length>0){let i=e.currentModel||u[0].id,b=u.find(L=>L.id===i);await e.setModel(b?b.id:u[0].id),p=!0}k?.setModel(e.currentModel),e.currentModel&&(T.notifyModelChanged(e.currentModel),A.notifyModelChanged(e.currentModel))}catch{}return p}else return r&&await c.window.showWarningMessage("SageLLM: Gateway not reachable. Configure and start now?","Configure Server","Dismiss")==="Configure Server"&&c.commands.executeCommand("sagellm.configureServer"),!1}let l=0,w=10;async function h(){if(l++,l>w)return;let r=Math.min(2e3*l,3e4);setTimeout(async()=>{let g=l>=3;await m(g)||h()},r)}h()}function Ae(){ge(k),N&&clearInterval(N)}function $e(o){let e=c.workspace.getConfiguration("sagellm"),t=e.get("gatewayStartCommand","sagellm serve"),n=e.get("gateway.port",P),s=e.get("preloadModel","").trim(),a=e.get("backend","").trim();if(D&&!D.killed){c.window.showInformationMessage("SageLLM: Gateway is already running");return}let d=t;a&&(d+=` --backend ${a}`),s&&(d+=` --model ${s}`),d+=` --port ${n}`;let m=c.window.createTerminal({name:"SageLLM Gateway",isTransient:!1,env:{SAGELLM_PREFLIGHT_CANARY:"0"}});m.sendText(d),m.show(!1),o?.setConnecting(),c.window.showInformationMessage(`SageLLM: Starting gateway with "${d}"\u2026`);let l=0,w=100,h=setInterval(async()=>{if(l++,await M())clearInterval(h),o?.setGatewayStatus(!0),c.window.showInformationMessage("SageLLM: Gateway is ready \u2713");else if(l>=w)clearInterval(h),o?.setError("Gateway start timed out"),c.window.showWarningMessage("SageLLM: Gateway did not respond within 5 minutes. Check the terminal for errors.");else if(l%20===0){let g=Math.round(l*3/60);o?.setConnecting(),c.window.setStatusBarMessage(`SageLLM: Loading model\u2026 (${g} min elapsed)`,5e3)}},3e3)}function ge(o){D&&!D.killed&&(D.kill("SIGTERM"),D=null),o?.setGatewayStatus(!1)}function _e(o){let e=c.window.createWebviewPanel("sagellm.installGuide","SageLLM: Installation Guide",c.ViewColumn.One,{enableScripts:!1});e.webview.html=Ge()}function Ge(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
